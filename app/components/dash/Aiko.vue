    ...
    <div class="p-6 border-b border-gray-200 dark:border-gray-700">
      <div class="flex items-center gap-3">
        <img
          src="/images/aiko.jpg"
          alt="Aiko"
          class="w-20 h-20 rounded-full object-cover ring-2 ring-cyan-500"
        />
        <div>
    ...
    <div ref="chatContainer" class="flex-1 overflow-y-auto p-6 space-y-4">
      ...
      >
        ...
        <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-2">
          Welcome to Aiko Chat!
        </h3>
        <p class="text-gray-600 dark:text-gray-400 max-w-sm">
          I'm here to help you stay organized and answer any questions you might
          have.
        </p>
      </div>
      <template v-else>
      ...
      <div class="flex gap-2">
        ...
        <button
          :class="[
            ...
            newMessage.trim()
              ? 'bg-cyan-500 border-none hover:bg-cyan-600 text-white'
              : 'border-none bg-gray-300 text-gray-500 cursor-not-allowed',
          ]"
