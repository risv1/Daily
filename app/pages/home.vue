  ...
  <main class="flex flex-col gap-3 w-full h-full">
    ...
    >
      <div class="flex justify-between items-center mb-4">
        ...
        <span class="text-sm font-medium text-cyan-500"
          >{{ completedTasks }}/{{ todayTasks.length }} completed</span
        >
      </div>
      <div class="space-y-3">
        <div
    ...
    >
      <div class="flex justify-between items-center">
        <div class="flex items-center gap-3">
          <div
            class="p-3 bg-cyan-500 rounded-lg group-hover:bg-cyan-600 transition-colors"
          >
            <Icon
    ...
    >
      <div class="flex items-center justify-between mb-4">
        <div class="flex items-center gap-3">
          <div class="p-3 bg-cyan-500 rounded-lg">
            <Icon
              name="material-symbols:newspaper"
              class="w-6 h-6 text-white"
            />
          </div>
          <h2 class="text-2xl font-semibold text-gray-800 dark:text-white">
        ...
        <button
          class="text-cyan-500 hover:text-cyan-600 dark:hover:text-cyan-400 font-medium"
        >
          View All
        </button>
      </div>
